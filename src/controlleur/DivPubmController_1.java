 ...
 * @author Vladio
 */
public class DivPubmController_1 implements Initializable {
 ...
 public void LoadValues(Publication e) throws IOException {
    ...
    @FXML
    private void gotoaddComment(MouseEvent event) throws IOException {
        Parent root =FXMLLoader.load(getClass().getResource("/views/AjoutCommentaire.fxml"));
